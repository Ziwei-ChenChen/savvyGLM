...
#'
#' @description \code{savvy_glm2} is a modified version of \code{glm2} in the stats package, incorporating custom optimization methods.
...
#' @param model_class A character vector specifying the shrinkage model(s) to be used in the underlying fitter \code{savvy_glm.fit2}.
...
#' @param method The method to be used in fitting the model. The default is \code{savvy_glm.fit2}. This method uses iteratively reweighted least squares (IRLS)
...
#'
#' @return The value returned by \code{savvy_glm2} has exactly the same structure as that returned by \code{glm}, except for:
